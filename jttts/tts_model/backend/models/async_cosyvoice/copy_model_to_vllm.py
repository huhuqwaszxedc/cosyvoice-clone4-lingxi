...
target_file = os.path.join(target_dir, "cosyvoice3.py")

# 复制模型文件
file_path = os.path.abspath(__file__)
print(f"Current file path: {file_path}")

model_file = os.path.join(os.path.dirname(file_path), "vllm_use_cosyvoice_model.py")
...
new_entry = '    "CosyVoice3Model": ("cosyvoice3", "CosyVoice3Model"),  # noqa: E501\n'
...
# 检查是否已存在条目
entry_exists = any("CosyVoice3Model" in line for line in lines)
